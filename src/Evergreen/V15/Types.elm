...
type alias FrontendModel =
    ...
    , snippetText : String
    , snippets : List Evergreen.V15.Data.Datum
    , currentSnippet : Maybe Evergreen.V15.Data.Datum
...
type FrontendMsg
    ...
    | InputSnippet String
    | Save
    | EditItem Evergreen.V15.Data.Datum
    | Delete
    | InputSnippetFilter String
    | ExpandContractItem Evergreen.V15.Data.Datum
    | RandomOrder
    | ModificationOrder
    | RandomizedOrder (List Evergreen.V15.Data.Datum)
    | AdminRunTask
    | GetUsers
...
type ToBackend
    ...
    | RunTask
    | SendUsers
    | SaveDatum Username Evergreen.V15.Data.Datum
    | SendUserData Username
    | UpdateDatum Username Evergreen.V15.Data.Datum
    | DeleteSnippetFromStore Username Evergreen.V15.Data.DataId
...
type ToFrontend
    ...
    | GotUserData (List Evergreen.V15.Data.Datum)
